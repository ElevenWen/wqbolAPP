                ...
                if( this.isPhone  && this.password ){
	        		...
	        		.then((res)=>{
						...
						if(rec&&self.$route.params.type==3){ 
							self.$router.replace({name:'helpFriendPay',query:{orderNum:rec.orderNum,actPrice:rec.actPrice,customerId:this.$route.query.customerId}});
							return
						};
						...
						if(this.$route.query.orderNum!=undefined){ 
							this.$router.replace({name:'helpFriendPay',query:{orderNum:this.$route.query.orderNum,actPrice:this.$route.query.actPrice,customerId:this.$route.query.customerId}});
							return 
						};
...
//								console.log( "登录认证成功："+JSON.stringify(result) );
								...
								.then((res)=>{
									...
									if(self.$route.query.orderNum!=undefined){ 
										self.$router.replace({path:'/helpFriendPay',query:{orderNum:self.$route.query.orderNum,actPrice:self.$route.query.actPrice,customerId:this.$route.query.customerId}});
										return 
									};
