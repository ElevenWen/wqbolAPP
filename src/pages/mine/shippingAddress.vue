	...
	<div id="shippingAddress">
		<div class="shippingAddress"  v-show=" !showBank && !showCompany ">
			...
			<div class="address_list" v-if='cusDeliveryData.length > 0'>
				<ul>
					<li v-for="(data, index) in cusDeliveryData">
		...
		<div id="newSite"  v-show="showCompany">
			...
			<div class="newSite">
				<ul>
					...
					<li>
						<span>详细地址</span>
						<span><input type="text" placeholder="请输入详细地址（街道、楼牌号等）" ref="Address" v-model="Address" @blur="checkAddr" minlength="5" maxlength="100"></span>
					</li>
					<li>
						<span v-if='IsDefaults'  @click='IsDefaultClick'><img  src="../../assets/images/tabBar/select_boxS@3x.png" />&nbsp;默认地址</span>
						<span v-else  @click='IsDefaultClick'><img src="../../assets/images/tabBar/select_box@3x.png" />&nbsp;默认地址</span>
						<span>每次下单时会使用该地址</span>
					</li>
				</ul>
