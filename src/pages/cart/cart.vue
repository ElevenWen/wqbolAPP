  ...
  <div id="cart">
   ...
   <main class="cart-mianWrap" v-show="cartInfos.recordCount!=0">
    <ul class="cart-itemsWrap ">
            <li class="items-list" v-for="(value,index,key) in cartInfos.list" track-by="index" :key="index" :class="value.Type == 0 ?'singS':'nSingS'" ref="sing">
             <!-- 单品type0  -->
                ...
                <mt-cell-swipe
                  title=""
	                  :right="[
	                    {
	                      content: '删除',
	                      style: { background: '#FA2802', color: '#fff' ,width:'2rem','text-align':'center', 'justify-content': 'center'},
                      ...
                      <div class="innerWrap" @click="goProductDetails(value,value.Type)">
                        <div class="listImageWrap">
                          ...
                          <div class="purchWrap">
                           ...
                           <span class="oldPrice"><strong>{{value.OldPrice|currency}}</strong></span>
