...
export default {
  data() {
    return {
      ...
      abc: `https://api.wqbol.com/Payment/ProductsJson?out_trade_no=${this.$route.query.orderNum.toString()}&actPrice=${this.$route.query.actPrice}&flag=help&customerId=${this.$route.query.customerId}}`
    };
  },
  components: {
